  ...
  try {
    ...
    const match = await prisma.match.update({
      ...
      data: {
        ...
        ...(quarterScores && { quarterScores: typeof quarterScores === 'string' ? quarterScores : JSON.stringify(quarterScores) }),
        ...(matchResult && { result: matchResult }),
        ...(isHome !== undefined && { isHome }),
        ...(weather !== undefined && { weather }),
        ...(players && { players: typeof players === 'string' ? players : JSON.stringify(players) }),
        ...(playerStats && { playerStats: typeof playerStats === 'string' ? playerStats : JSON.stringify(playerStats) }),

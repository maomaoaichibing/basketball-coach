...
export async function POST(request: NextRequest) {
  try {
    ...
    const { playerId, playerName, periodStart, periodEnd, overallScore, dimensions, progress, strengths, weaknesses, potential, trainingSuggestions, method, analystId, analystName } = body

...
const defaultTemplates = [
  {
    ...
    title: '课时不足提醒',
    content:
      '亲爱的{{guardianName}}，您家孩子{{playerName}}的{{courseName}}课程剩余课时已不足{{remainingHours}}课时，建议及时续费。',
  ...
  },
  {
    ...
    title: '课程即将到期提醒',
    content:
      '亲爱的{{guardianName}}，您家孩子{{playerName}}的{{courseName}}课程将于{{expireDate}}到期，请注意合理安排训练时间。',
  ...
  },
  {
    ...
    title: '课程预约成功',
    content:
      '亲爱的{{guardianName}}，您已成功为孩子{{playerName}}预约{{courseName}}课程，时间：{{bookingDate}} {{bookingTime}}，地点：{{location}}。',
    variables:
      '["guardianName", "playerName", "courseName", "bookingDate", "bookingTime", "location"]',
    isActive: true,
    isAutomated: true,
    priority: 'normal',
  },
  {
    ...
    title: '课程即将开始提醒',
    content:
      '亲爱的{{guardianName}}，您家孩子{{playerName}}的{{courseName}}课程将于{{bookingTime}}开始，请提前10分钟到达{{location}}。',
  ...
  },
  {
    ...
    title: '训练课完成',
    content:
      '亲爱的{{guardianName}}，您家孩子{{playerName}}今日训练已完成。本次训练主题：{{trainingTheme}}，教练评价：{{coachFeedback}}。',
  ...
  },
  {
    ...
    title: '能力评估报告已生成',
    content:
      '亲爱的{{guardianName}}，您家孩子{{playerName}}的最新能力评估报告已生成。综合评分：{{overallScore}}分。点击查看详情。',

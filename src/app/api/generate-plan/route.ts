      ...
      "activities": [
        {
          ...
          "description": "【列队】【位置】【姿势】【动作】【发力】【次数】【形式】【要点目的】用简洁专业的中文描述。必须包含6个【】标签。示例1（运球）："【姿势】双脚与肩同宽，膝盖微屈，重心降低【位置】排面（3排每排4人）【动作】右手低运球3下接体前变向换左手，运3下后急停传球【发力】右手手腕下压按拍球【次数】每组30秒×3组，组间休息15秒【形式】原地排面进行【要点目的】强化体前变向运球的熟练度和节奏感" 示例2（传球）："【姿势】两人一组面对面，间距3米，膝盖微屈【位置】分组（2人一组共4组）【动作】双手胸前传球，持球于胸前手腕发力前推，连续传10次后交换位置【发力】双手同时向前发力，大拇指最后下压【次数】每组传10次×3组【形式】分组轮流【要点目的】掌握双手胸前传球的正确手型和发力方式"",
          "keyPoints": ["要点1", "要点2"],
          "sets": "2-3组（必须填写具体组数）",
...
- ❌ 错误："运球结合传球练习"（太笼统！必须写清楚怎么运球、运几下了怎么传球）
...
- 示例1："右手在体侧运球，高度在膝盖到腰部之间，运5下后体前变向换左手"
- 示例2："迈左脚向前跨出同时右手放球，蹬地起跳"
...
**❌ 错误示例（太笼统，绝对不允许）：**
"运球结合传球练习"——没写怎么运球、运几下、怎么传球、胸前还是击地、右手还是左手
"球性熟悉：进行原地运球、行进间运球、球绕环等练习"——没分开、没写细节

**✅ 正确示例（详细具体）：**
"右手原地高低运球：
【姿势】双脚与肩同宽，膝盖微屈，重心降低，右手持球于体侧
【动作】右手在体侧运球，球高过膝盖但不高于腰部，眼睛看前方。先高运球5下，再低运球5下，交替进行
...
**⚠️ 你在写每个活动的 duration 时，必须在脑中计算实际耗时，然后再标注！**
...
- ❌ 错误："两人一组传球练习，15分钟"
  - 实际：4组轮流 × 2分钟 = 8分钟，标注15分钟过长！正确应该是8-10分钟
- ❌ 错误："投篮练习10次，10分钟"
  - 实际：10次投篮约1分钟，标注10分钟严重不符！正确应该是2-3分钟
- ✅ 正确："行进间体前变向运球，底线到罚球线往返3组，3分钟"
  - 实际：3组 × (20秒运球 + 10秒回位) = 90秒 ≈ 1.5分钟，标注3分钟合理（含讲解、等待）
- ✅ 正确："两人一组双手胸前传球，每组传20次×3组，5分钟"
  - 实际：3组 × (20次×2秒 + 15秒休息) = 165秒 ≈ 2.75分钟，标注5分钟合理（含轮换）
...
**每个技术动作的 description 中必须包含以下精确细节，这是教练看教案最需要的：**
...
- 变向方式：体前变向/胯下/背后/转身
- ❌ 错误："运球结合传球"（没写怎么运、运几下、怎么传）
- ✅ 正确："右手低运球3下，接体前变向换左手，再运3下后急停，双手胸前传球给对面的同伴"

**传球类动作（必须写清楚）：**
- 哪只手：双手/单手（右手/左手）
- 传球方式：胸前传球/击地传球/头上传球/单手肩上传球/手递手
- 传几次：明确次数（如"连续传5次后交换""传10次换动作"）
- 距离：近距离（2米）/中距离（3-4米）/远距离（5米以上）
- ❌ 错误："传球练习"（没写怎么传、传什么球）
- ✅ 正确："两人一组间距3米，双手胸前传球，连续传10次后交换位置，3组。传球时双手持球于胸前，手腕发力前推，球要有回旋"
...
- ❌ 错误："投篮练习"（没写怎么投、在哪里投、投几个）
- ✅ 正确："右侧45度角三分线内一步，接球后面向篮筐，双脚跳起，右手单手拨球投篮。每个位置投5次，命中3个后换下一个位置，左右两侧各3组"
...
- ❌ 错误："防守滑步练习"（没写滑到哪里、保持什么距离）
- ✅ 正确："从底线到罚球线做防守滑步，保持半臂距离面对假想对手，双手张开，重心降低，到达罚球线后交叉步返回底线，往返3组"
...
- **抢断反击快攻**：防守抢断后立刻发动快攻
  - 组织：3-5人
  - 步骤：抢断→立刻传给快下队友→接球上篮/投篮
  - 要点：抢断后第一时间出球，不运球

- **篮板一传快攻**：抢到篮板后一传发动快攻
  - 组织：5人
  - 步骤：中锋抢板→一传给后卫→后卫推进→分球给两侧快下队员
  - 要点：中锋抢板后要抬头找人，一传要快要准
...
- **传切配合（空切）**：无球队员突然空切篮下接球
  - 组织：3人（1持球+2无球）
  - 步骤：持球人在弧顶→无球队员从底线或侧翼突然切入→接球上篮
  - 要点：假动作摆脱，切入时机要准确

- **突分配合**：持球人突破吸引防守后分球给空位队友
  - 组织：3-4人
  - 步骤：持球人突破→吸引2人包夹→分球给外线空位→接球投篮
  - 要点：突破要坚决，分球要及时，队友要提前跑位
...
- **反跑配合**：无球队员假装向一个方向移动，突然反方向跑接球
  - 组织：2-3人
  - 步骤：无球人先向有球方向移动（假装要接球）→突然反方向加速跑→接球投篮
  - 要点：假动作要逼真，反跑要突然加速

- **高低位策应配合**：内线球员在高位接球，低位球员空切接球
  - 组织：3人（高位策应+低位空切+传球人）
  - 步骤：传球人把球传给罚球线附近的高位策应者→低位球员从弱侧空切→高位策应者传球给低位→低位上篮
  - 要点：策应者要能传球，空切时机要准确

**3. 整体阵地进攻体系**
- **动态进攻**：通过不断传球和空切寻找机会
  - 组织：5人，原则：球动人动，每次传球后都有人空切或掩护

- **普林斯顿进攻**：强调传球、空切、背身单打结合
  - 组织：5人，后卫将球传给高位策应者，然后空切或做掩护

- **内线强攻体系**：以内线球员为核心，外线围绕内线跑位
  - 组织：5人，重点给内线创造一对一机会

- **外线投射体系**：通过传导和掩护为外线射手创造空位
  - 组织：5人，多次传导拉开空间，通过无球掩护创造投篮机会

**4. 破防守专用进攻**
- **破人盯人进攻**：利用挡拆、换位、空切破解人盯人
  - 方法：频繁挡拆→掩护后顺下→空切→吸引包夹后分球

- **破区域联防进攻**：利用溜底、中路突破、外线穿插破解联防
  - 方法：球转移到弱侧→溜底线→中路突破分球→外线轮转投篮

- **破全场紧逼进攻**：利用中路推进、边线接应、长传破解
  - 方法：中锋拉到后场接应→中场有人策应→长传给快下队员
...
- **2-3联防（护内线）**：2人在外线，3人在内线
  - 站位：弧顶2人，底线3人，重点保护内线和篮板

- **3-2联防（防外线）**：3人在外线，2人在内线
  - 站位：弧顶1人，两侧各1人，内线2人，重点防外线投篮

- **1-3-1联防（均衡防守）**：1人压迫持球，3人中间覆盖，1人保护篮下
  - 站位：弧顶1人，两侧罚球线延长线各1人，罚球圈1人，篮下1人

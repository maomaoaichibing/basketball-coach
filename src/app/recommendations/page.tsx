      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        {playerInfo && (
          <div className="bg-white rounded-lg shadow p-5 mb-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">{playerInfo.name} - 能力雷达</h2>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {['dribbling', 'passing', 'shooting', 'defending', 'physical', 'tactical'].map((skill) => {
                    ...
                    {rec.type === 'position' && rec.suggestedPosition && (
                      <div className="mt-3 flex items-center gap-4">
                        ...
                        <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm font-medium">
                          {rec.suggestedPosition === 'guard' ? '后卫' : rec.suggestedPosition === 'forward' ? '前锋' : '中锋'}
                        </span>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                当前的推荐基于规则引擎生成。随着数据积累，未来将接入 AI 大模型提供更精准、更个性化的训练建议和发展规划。
              </p>
            </div>
          </div>
        </div>
